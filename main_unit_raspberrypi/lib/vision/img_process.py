...
class ImgProcess:
    ...
    def __calc_dist(self,object_width_in_pixels,image_width_in_pixels,focal_length_in_mm=3.04, sensor_width_in_mm=2.76, objects_real_width_in_mm=40):
        focal_length_in_pixels = (image_width_in_pixels/sensor_width_in_mm)*focal_length_in_mm
        distance_to_object = (objects_real_width_in_mm*focal_length_in_pixels)/object_width_in_pixels
        return distance_to_object

    def detect_pucks(self,frame,lower_color_threshold,upper_color_threshold,puck_real_width_in_mm=40,focal_length_in_mm=3.04,sensor_width_in_mm=2.76,width_threshold=40,similarity_threshold=0.05): # Detect pucks by color and contour
            ...
            if(sim<similarity_threshold):
                ...
                if(w>width_threshold):
                    puck_info = {
                        ...
                        "height": int(h),
                        "sim": sim,
                        "distance": self.__calc_dist(w,image_width,focal_length_in_mm,sensor_width_in_mm,puck_real_width_in_mm)
                    }
